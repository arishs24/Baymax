...
def load_voices_data():
    # Get the absolute folder path for core.py
    core_dir = os.path.dirname(os.path.abspath(__file__))
    # Build the absolute path to tts_voices.json
    voices_json_path = os.path.join(core_dir, "rvc", "lib", "tools", "tts_voices.json")

    with open(voices_json_path, "r", encoding="utf-8") as file:
